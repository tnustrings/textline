...
func main() {
  if os.Args[1] == "words" {
    ...
    fmt.Println(Lingobin(string(CatStdin()), langa, dict))
  }
}
// Lingobin puts word-by-word translations into text
func Lingobin(text string, langa string, dict map[string]interface{}) string {
